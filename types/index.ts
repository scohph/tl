...
export type { Multisend } from "./contracts/Multisend";
export { Multisend__factory } from "./factories/contracts/Multisend__factory";
export type { TRLOOP } from "./contracts/TRLOOP";
export { TRLOOP__factory } from "./factories/contracts/TRLOOP__factory";
